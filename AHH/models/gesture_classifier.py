...
class GestureClassifier:
    ...
    def __init__(self, model_path=None, label_path=None):
        ...
        if model_path is None:
            model_path = os.path.join(MODEL_WEIGHTS_DIR, "gesture_model.tflite")
        
        if label_path is None:
            label_path = os.path.join(MODEL_WEIGHTS_DIR, "gesture_labels.txt")
        ...
        self.keypoints_mean = np.load(os.path.join(MODEL_WEIGHTS_DIR, "keypoints_mean.npy"))
        self.keypoints_std = np.load(os.path.join(MODEL_WEIGHTS_DIR, "keypoints_std.npy"))
